 ...
 * 小主播端
 */
public class PlayActivity extends AppCompatActivity implements ITXLivePushListener {
    private PlayActivity.TCPlayItem mPlayItem1;
    ...
    private String mPushUrl = "rtmp://4005.livepush.myqcloud.com/live/4005_xiao?bizid=4005&txSecret=e8dc9d110c67878e16601f93483c3ea1&txTime=58B8417F";//小主播推流地址
    private String mPlayUrl = "rtmp://4005.liveplay.myqcloud.com/live/4005_da?bizid=4005&txTime=58B8417F";//大主播拉流地址
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPushUrl += String.format("&mix=layer:s;t_id:1;session_id:%s", mSessionID);
        mPlayUrl = new StringBuilder(mPlayUrl).append("&txSecret=").append(getSecretKey()).append("&session_id=").append(mSessionID).toString();
        Log.e(TAG,"小主播推流地址："+mPushUrl);
        Log.e(TAG,"大主播拉流地址："+mPlayUrl);
        initView();
        startPublish();
    }
    public String getSecretKey(){
        String secretKey = "";
        secretKey = MD5Utils.getMD5(key + "4005_da"+"58B8417F");
        return secretKey;
    }
    ...
    private void initLinkMicView() {
        ...
        mPlayItem1 = new PlayActivity.TCPlayItem();
        mPlayItem1.mVideoView = (TXCloudVideoView) findViewById(R.id.play_video_view1);
        mPlayItem1.mTXLivePlayer = new TXLivePlayer(this);
        mPlayItem1.mTXLivePlayer.setPlayListener(new PlayActivity.TXLivePlayListener(mPlayItem1));
    ...
    protected void startPublish() {
        ...
        if (mTXLivePusher == null) {
            mTXLivePusher = new TXLivePusher(PlayActivity.this);
            mTXLivePusher.setPushListener(PlayActivity.this);
    ...
    private class TXLivePlayListener implements ITXLivePlayListener {
        private PlayActivity.TCPlayItem item;

        public TXLivePlayListener(PlayActivity.TCPlayItem item) {
            this.item = item;
        }
